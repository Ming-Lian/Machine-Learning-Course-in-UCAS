...
- [神经网络训练细节](#details-to-train-neural-network)
	...
	- [超参数优化](#hyperparameter-optimization)
		...
		- [观察损失函数变化形式推测可能的超参数优化问题](#analysis-change-of-loss-function)
...
<a name="analysis-change-of-loss-function"><h4>观察损失函数变化形式推测可能的超参数优化问题 [<sup>目录</sup>](#content)</h4></a>

- 形式一

<table>
<tr>
	<td><img src=./picture/CV-training-hyperparameter-optimization-analysis-change-of-loss-function-1.png width=600 /></td>
...
<table>
<tr>
	<td><img src=./picture/CV-training-hyperparameter-optimization-analysis-change-of-loss-function-2.png width=600 /></td>
	<td><p>一开始有一个很高的平稳值，然后在某一个时间点，突然开始下降——可能原因——初始值选的不好。</p><p>一个错误的初始值会让梯度值在一开始就接近于0，使得损失函数在一开始几乎没有下降，直到运动到某一个点的梯度才有了明显的变化</p></td>
</tr>
</table>
