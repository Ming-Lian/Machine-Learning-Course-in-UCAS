...
<p align="center"><img src=./picture/CV-training-hyperparameter-optimization-analysis-change-of-loss-function-1.png width=400 /></p>

损失函数的变化趋势并不是期望中的指数化，而有点接近于线性函数——可能原因：学习率太低了

- 形式二

<p align="center"><img src=./picture/CV-training-hyperparameter-optimization-analysis-change-of-loss-function-2.png width=400 /></p>
